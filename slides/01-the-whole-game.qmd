...
- **GitHub Desktop:** recommended if it is installed; no terminal required.
- **Positron Source Control:** use the built-in Git panel if Git is installed.
...
asking who has GitHub Desktop and direct them to that path. For students using
